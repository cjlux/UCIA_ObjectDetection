...
\begin{frame}{Détection d'objets 3D : \\Performances des réseaux entraînés}
  ...
  \item Programme Python \fileBF{process\_results.py} produit la synthèse des rélustats.\smallskip
...
\begin{frame}{Détection d'objets 3D : \\Performances des réseaux entraînés}
  ...
  {\small Tri \Chocolate{recall} et \Chocolate{mAP50-95} \hspace*{2cm} Tri  \Chocolate{fitness}}
    
    \smallskip
    \hspace*{-1cm}\includegraphics[height=.56\textwidth]{images/Results_recall_mAP50-95_V2.png}
    \hfill}\includegraphics[height=.56\textwidth]{images/Results_fitness_V2.png}
